...
// const byte SECRET_PICC_MASTER_KEY[24] = { 0xEA, 0x2F, 0xBB, 0x92, 0x1C, 0x76, 0xFF, 0x65, 0xB6, 0xD2, 0x78, 0x44, 0xF8, 0x0F, 0x8D, 0x1B, 0xE7, 0xC2, 0xCC, 0x89, 0x04, 0xC0, 0x7D, 0xE3 };
const byte SECRET_PICC_MASTER_KEY[16] = { 0xEA, 0x2F, 0xBB, 0x92, 0x1C, 0x76, 0xFF, 0x65, 0xB6, 0xD2, 0x78, 0x44, 0xF8, 0x0F, 0x8D, 0x1B };
...
// const byte SECRET_APPLICATION_KEY[24] = { 0xEA, 0xDF, 0x6A, 0xD9, 0x89, 0xE9, 0x4B, 0xD1, 0xC5, 0xB3, 0xE3, 0x9D, 0xE9, 0xE9, 0x43, 0xE3, 0x5B, 0x60, 0x85, 0x8B, 0x99, 0xD8, 0xD3, 0x5B };
const byte SECRET_APPLICATION_KEY[16] = { 0xEA, 0xDF, 0x6A, 0xD9, 0x89, 0xE9, 0x4B, 0xD1, 0xC5, 0xB3, 0xE3, 0x9D, 0xE9, 0xE9, 0x43, 0xE3 };
...
// const byte SECRET_STORE_VALUE_KEY[24] = { 0xEA, 0x5D, 0x78, 0x57, 0x68, 0xFC, 0xEE, 0xC9, 0x40, 0x2F, 0x30, 0xDE, 0xEC, 0xA9, 0x8B, 0x92, 0x7F, 0x8A, 0xC9, 0xC3, 0xAA, 0xD7, 0x4F, 0x17 };
const byte SECRET_STORE_VALUE_KEY[16] = { 0xEB, 0x5D, 0x78, 0x57, 0x68, 0xFC, 0xEE, 0xC9, 0x40, 0x2F, 0x30, 0xDE, 0xEC, 0xA9, 0x8B, 0x92 };

// const byte SECRET_READ_VALUE_KEY[24] = { 0xEA, 0xEA, 0x78, 0x57, 0x68, 0xFC, 0xEE, 0xC9, 0x40, 0x2F, 0x30, 0xDE, 0xEC, 0xA9, 0x8B, 0x92, 0x7F, 0x8A, 0xC9, 0xC3, 0xAA, 0xD7, 0x4F, 0x17 };
const byte SECRET_READ_VALUE_KEY[16] = { 0xEA, 0xEA, 0x78, 0x57, 0x68, 0xFC, 0xEE, 0xC9, 0x40, 0x2F, 0x30, 0xDE, 0xEC, 0xA9, 0x8B, 0x92 };

// -----------------------------------------------------------------------------------------------------------

// The ID of the application to be created
// This value must be between 0x000001 and 0xFFFFFF (NOT zero!)
const uint32_t CARD_APPLICATION_ID = 0x001200;
...
const byte ACCESS_CTRL_UID[16] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 };
